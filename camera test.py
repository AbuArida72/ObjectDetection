...
width = 1080
height = 720
cap = cv2.VideoCapture("car file/webcam.mp4")
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if (currentClass == "person" or currentClass == "bottle") and conf > 0.3:
    ...
    for results in resultsTracker:
        ...
        if limits[0]-5 < cx < limits[2] + 5 or limits[1] < cy < limits[3]:
